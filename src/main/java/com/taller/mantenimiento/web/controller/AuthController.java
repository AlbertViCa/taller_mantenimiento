...
import com.taller.mantenimiento.business.domain.dto.AuthenticationRequest;
import com.taller.mantenimiento.business.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try{
            ...
            UserDetails userDetails = workshopUserDetailsService.loadUserByUsername(request.getUsername());
